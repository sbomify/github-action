...
def print_banner(version: str = "unknown") -> None:
    ...
    banner = Text()
    banner.append("         __                    _ ____         ___        __  _           \n", style=BRAND_COLORS["blue"])
    banner.append("   _____/ /_  ____  ____ ___  (_) __/_  __   /   | _____/ /_(_)___  ____ \n", style=BRAND_COLORS["purple_light"])
    banner.append("  / ___/ __ \\/ __ \\/ __ `__ \\/ / /_/ / / /  / /| |/ ___/ __/ / __ \\/ __ \\\n", style=BRAND_COLORS["purple"])
    banner.append(" (__  ) /_/ / /_/ / / / / / / / __/ /_/ /  / ___ / /__/ /_/ / /_/ / / / /\n", style=BRAND_COLORS["pink"])
    banner.append("/____/_.___/\\____/_/ /_/ /_/_/_/  \\__, /  /_/  |_\\___/\\__/_/\\____/_/ /_/ \n", style=BRAND_COLORS["peach"])
